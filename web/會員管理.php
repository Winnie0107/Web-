...
<body>
            ...
            <div class="col-12" align="right">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="會員管理.php" class="active">會員管理</a></li>
                        <?php }?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <h2>會員管理</h2>
          <p><font color="white" size="4">刪除、新增會員資料</font></p>
        </div>
      </div>
    </div>
  </div>
  ...
  $sql="select * from login WHERE 權限='會員'";
  ...
  <table border="2" width="1000" height="200" align="center" class="table-bordered">
    ...
    <div class="main-button" align="center" style="margin-top:60px;">
              
        <a href="新增.php">新增會員</a>
