            ...
            <div class="col-12" align="right">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <?php }else{?>
                          <li><a href="登入.php" class="active">登入</a></li>
                          <?php }?>
                    </ul>   
  ...
  <div class="reservation-form">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <form id="reservation-form" name="gs" method="post" role="search" action="登入後端.php">
            <div class="row">
              <div class="col-lg-12">
                <h4><em>會員、管理者登入</em></h4>
              </div>
              <div class="col-lg-6">
                  <fieldset>
              ...
              <div class="col-lg-6">
                <fieldset>
                    <label for="Number" class="form-label">密碼</label>
              ...
              <div class="col-lg-12">                        
                  <fieldset>
                      <button class="main-button">登入</button>
                  </fieldset>
              </div>
            </div>
          </form>
