        ...
        <div id="top-banner-3" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Welcome To The Department Of Information Management </h2>
              <h1>權限管理</h1>
              <div class="border-button"><a href="權限管理.php">Go There</a></div>
            </div>
            <div class="container">
              <div class="row">
                <div class="col-lg-10">
        ...
        <div id="top-banner-4" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Welcome To The Department Of Information Management </h2>
              <h1>會員管理</h1>
              <div class="border-button"><a href="會員管理.php">Go There</a></div>
            </div>
            <div class="container">
              <div class="row">
                <div class="col-lg-10">
        ...
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading text-center">
            ...
            <div class="main-button" align="center">
              ...
              <a href="announcement.html">新增最新消息</a>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
                        ...
                        <div class="main-button" style="position:relative;top:10px">
                          <a href="確認修改.php?number=<?php echo $row['number']?>">修改</a>
                          <a href="確認刪除.php?number=<?php echo $row['number']?>">刪除</a>
                        </div>
